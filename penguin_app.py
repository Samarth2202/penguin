...
bill_len = st.sidebar.sliders('Bill Length mm',df['bill_length_mm'].min(),df['bill_length_mm'].max())
bill_depth = st.sidebar.sliders('Bill Depth mm',df['bill_depth_mm'].min(),df['bill_depth_mm'].max())
flip_len = st.sidebar.sliders('Flipper Length mm',df['flipper_length_mm'].min(),df['flipper_length_mm'].max())
body_mass = st.sidebar.sliders('Body Mass g',df['body_mass_g'].min(),df['body_mass_g'].max())
